...
public static class RendererExtension
{
    ...
    {
        coroutineHandler.StartCoroutine(HeightlightObject(renderer, color, returnColor, time));
    }

    private static IEnumerator HeightlightObject(Renderer obj, Color color, Color returnColor, float time)
    {
